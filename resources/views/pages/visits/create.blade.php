        ...
        <div class="bg-blue-50 rounded-lg p-4 border border-blue-200 mb-6">
            ...
            @if($contract->address)
                <div class="mt-3 p-3 bg-blue-100 rounded border border-blue-200">
                    ...
                    <span class="text-blue-900">{{ $contract->address->area }} - {{ __('Block') }} {{ $contract->address->block }} - {{ __('Street') }} {{ $contract->address->street }} - {{ __('House') }} {{ $contract->address->house }} - {{ $contract->address->floor }} - {{ $contract->address->flat }}</span>
                </div>
            @endif
        </div>
