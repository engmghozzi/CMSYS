            ...
            <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="centeral_machines" value="{{ old('centeral_machines', isset($contract) ? $contract->centeral_machines : 0) }}" required class="w-full border rounded px-4 py-2 bg-white shadow-sm" />
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('Unit Machines') }}</label>
                        <input type="number" name="unit_machines" value="{{ old('unit_machines', isset($contract) ? $contract->unit_machines : 0) }}" required class="w-full border rounded px-4 py-2 bg-white shadow-sm" />
                    </div>
