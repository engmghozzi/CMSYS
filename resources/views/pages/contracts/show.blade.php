                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 min-h-[80px]">
                                        ...
                                        <div class="flex gap-1 shrink-0">
                                            ...
                                            @endif
                                            @if(auth()->user()->hasPermission('payments.delete') && ($contract->status === 'active' && !$contract->is_expired || (auth()->user()->role && auth()->user()->role->name === 'super_admin' && ($contract->status === 'expired' || $contract->is_expired))))
