<x-layouts.app :title="__('Create Feature')">
    <x-ui.form-layout
        :title="__('Create Feature')"
        :description="__('Add a new feature to the system')"
        :back-url="route('features.index')"
        :back-label="__('Back to Features')"
    >
