        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">{{ __('Edit Feature') }}</h1>
                        <p class="mt-1 text-sm text-gray-600">{{ __('Update feature information') }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow border border-gray-200">
                ...
                <form method="POST" action="{{ route('features.update', $feature) }}" class="p-6">
                    @csrf
                    @method('PUT')
            ...
            <div class="mt-6 bg-white rounded-lg shadow border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Current Usage') }}</h3>
                    <p class="mt-1 text-sm text-gray-600">{{ __('This feature is currently assigned to the following users and roles') }}</p>
                </div>
